        ...
        <div class="flex flex-col lg:flex-row text-left lg:text-left">
            ...
            <div class="w-full lg:w-6/12 px-4 mb-6 lg:mb-0">
                ...
                <div class="mt-6 flex justify-center lg:justify-start flex-wrap">
                    <button
                        class="bg-white shadow-lg font-normal h-10 w-10 flex items-center justify-center rounded-full outline-none focus:outline-none mr-2 mb-2"
                        type="button">
            ...
            <div class="w-full lg:w-6/12 px-4">
                <div class="flex flex-col lg:flex-row items-start lg:items-top mb-6">
                    <div class="w-full lg:w-4/12 px-4 lg:ml-auto mb-4 lg:mb-0">
                        ...
                        @auth
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                                        href="{{ route('anggota.berandaAnggota') }}">Beranda</a>
                                </li>
                                <li>
                                    <a class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                                        href="{{ route('anggota.layoutsRiwayat') }}">Riwayat</a>
                                </li>
                                <li>
                                    <a class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                                        href="{{ route('anggota.layoutskoleksi') }}">Koleksi</a>
                                </li>
                                <li>
                                    <a class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                                        href="{{ route('anggota.anggota_pengumuman') }}">Pengumuman</a>
                                </li>
                            </ul>
                        @endauth
                        @guest
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="#beranda"
                                        class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm">Beranda</a>
                                </li>
                                <li>
                                    <a href="#tentang"
                                        class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm">Tentang</a>
                                </li>
                                <li>
                                    <a href="#buku-populer" class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm">Buku
                                        Populer</a>
                                </li>
                                <li>
                                    <a href="#pengurus"
                                        class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm">Pengurus</a>
                                </li>
                            </ul>
                        @endguest
                    ...
                    <div class="w-full lg:w-4/12 px-4">
                        ...
                        <ul class="list-unstyled">
                            <li><a class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                                    href="https://x.com">Twitter</a></li>
                            <li><a class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                                    href="https://www.facebook.com">Facebook</a></li>
                            <li><a class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                                    href="https://mail.google.com">Email</a></li>
                            <li><a class="text-[#64C0B7] hover:text-blueGray-800 font-semibold block pb-2 text-sm"
        ...
        <div class="flex flex-col md:flex-row items-center md:justify-between justify-center">
            <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                <div class="text-sm text-blueGray-500 font-semibold py-1">
                    ...
                    <a href="https://uad.ac.id" class="text-blueGray-500 hover:text-gray-800">Universitas Ahmad
                        Dahlan</a>.
                </div>
            </div>
        </div>
