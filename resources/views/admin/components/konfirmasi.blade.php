...
@section('content')
    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Konfirmasi Peminjaman</h1>
            </div>
            <div class="sm:flex">
            </div>
        </div>
                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @include('admin.components.crud.data_konfirmasi')
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    {{-- @include('admin.components.crud.edit_voluntter') --}}
