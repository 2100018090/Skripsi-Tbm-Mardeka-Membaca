{{-- =====================  MODAL  ===================== --}}
<div id="add-volunteer-modal"
     class="fixed inset-0 z-50 hidden overflow-y-auto overflow-x-hidden h-modal sm:h-full">
    <div class="relative w-full h-full max-w-2xl px-4 md:h-auto mx-auto mt-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                ...
                <button type="button"
                        data-modal-hide="add-volunteer-modal"
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('admin.createVoluntter') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex justify-end items-center pt-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                        <button type="submit"
