{{-- =====================  Buku  ===================== --}}
<div id="add-buku-fisik" class="fixed inset-0 z-50 hidden overflow-y-auto overflow-x-hidden h-modal sm:h-full">
    <div class="relative w-full h-full max-w-2xl px-4 md:h-auto mx-auto mt-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                ...
                <button type="button" data-modal-hide="add-buku-fisik"
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('admin.createBuku') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <input type="hidden" id="tipe" name="tipe" value="fisik">
...
{{-- ========  Script pengendali tipe  ======== --}}
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const tipeSelect = document.getElementById('tipe');
            const digitalWrap = document.getElementById('digital-input');
            const fisikWrap = document.getElementById('fisik-input');
            ...
            function toggleFields() {
                ...
                fisikWrap.classList.add('hidden');
                ...
                if (val === 'digital') {
                    ...
                    fisikWrap.classList.remove('hidden');
                    stokInput.required = true;
                    fileInput.value = '';
                }
            }

            toggleFields(); // jalankan sekali (form edit)
