{{-- =====================  Kategori  ===================== --}}
<div id="add-kategori-modal" class="fixed inset-0 z-50 hidden overflow-y-auto overflow-x-hidden h-modal sm:h-full">
    <div class="relative w-full h-full max-w-2xl px-4 md:h-auto mx-auto mt-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                ...
                <button type="button" data-modal-hide="add-kategori-modal"
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('admin.createKategori') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input id="nama" name="nama" type="text" required placeholder="Masukkan Kategori"
